...
3. Definer funksjonen $f(x) = (1 + t)^{1/t}$ ved å skrive ~f(x) := (1 + t)^(1/t)~ i CAS. Merk at det er vesentlig å skrive ~:=~, ikke kun ~=~. Vi skal her fortelle CAS om en ny funksjon, $f(x)$, ikke løse en likning.
