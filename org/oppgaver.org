...
- b :: Et punkt $P$ ligger på linja $l$. Forklar at vi kan skrive $\vec{AP} ) \left[3 + t, -3 + 5t\right]$ for en $t\in \doubleR$.
- c :: Bruk blant annet skalarproduktet til å finne koordinatene til $P$ slik at $\vec{AB} \norm \vec{AP}$.
